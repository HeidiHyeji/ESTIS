...
<%
	...
	if (action.equals("go")) {
		...
		ArrayList<String> phoneList = (ArrayList<String>) sc.getAttribute("phoneList");
		for (int k = 0; k < phoneList.size(); k++) {
			String rphone = base64Encode(nullcheck(phoneList.get(k), ""));
			...
			String arrKey[] = new String[] { "user_id", "secure", "msg", "rphone", "sphone1", "sphone2",
					"sphone3", "rdate", "rtime", "mode", "testflag", "destination", "repeatFlag", "repeatNum",
					"repeatTime", "smsType", "subject" };
